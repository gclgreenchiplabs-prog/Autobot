...
class NotificationType(str, Enum):
    ...
    BROKER_SDK_MISSING = "BROKER_SDK_MISSING"
    ...
    BROKER_MODE_CHANGED = "BROKER_MODE_CHANGED"
    ...
    INSTRUMENT_IMPORT_STARTED = "INSTRUMENT_IMPORT_STARTED"
    INSTRUMENT_IMPORT_COMPLETED = "INSTRUMENT_IMPORT_COMPLETED"
    INSTRUMENT_IMPORT_FAILED = "INSTRUMENT_IMPORT_FAILED"
    INSTRUMENT_CONFLICT_DETECTED = "INSTRUMENT_CONFLICT_DETECTED"
    INSTRUMENT_MAPPING_MISSING = "INSTRUMENT_MAPPING_MISSING"
    INSTRUMENT_MAPPING_STALE = "INSTRUMENT_MAPPING_STALE"
    INSTRUMENT_MAPPING_CONFLICT = "INSTRUMENT_MAPPING_CONFLICT"
    DATA_QUALITY_DEGRADED = "DATA_QUALITY_DEGRADED"
    QUOTE_STALE = "QUOTE_STALE"
    LIQUIDITY_FILTER_REJECTED = "LIQUIDITY_FILTER_REJECTED"
    SPREAD_FILTER_REJECTED = "SPREAD_FILTER_REJECTED"
    ...
    MARKET_DATA_RECONNECTING = "MARKET_DATA_RECONNECTING"
    ...
    QUOTE_CACHE_STALE = "QUOTE_CACHE_STALE"
